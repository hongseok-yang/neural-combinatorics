...
| strip: the scalar `D ≤ Σ` itself (`app:constants`, `eq:constant-A/B`) | 📝 | `P_ge_51`+`P_ge_72` done (the `P`-factor bounds); still needs `B₀/B₁` rpow bounds + `m≥500` growth + finite rational sweep `63≤m≤499` (code-gen scale) |
