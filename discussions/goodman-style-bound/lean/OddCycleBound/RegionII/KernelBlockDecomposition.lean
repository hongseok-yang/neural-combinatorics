import OddCycleBound.RegionII.OneSidedPolynomial
import OddCycleBound.RegionII.TracePowers
...
lemma good_degCentered_of_goodK (hK : GoodK K) :
  ...
  exact good_sub hdegree
    (OddCycleBound.HighDensity.good_const (Omega := Omega) (edgeDensity K mu))
