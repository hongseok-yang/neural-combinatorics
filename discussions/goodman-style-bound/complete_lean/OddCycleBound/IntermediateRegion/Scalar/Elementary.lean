...
the scalar branch analysis, including the corrected eigenvalue-gap estimate.
-/
...
/-- First corrected eigenvalue-gap inequality: `d + L <= 1/3`. -/
...
/-- Corrected eigenvalue-gap bound `f >= d + delta`. -/
...
/-- The defect in the ratio form used by the scalar branch analysis. -/
