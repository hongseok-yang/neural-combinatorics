# Compact Atlas188 certificate

Status (2026-09-23): **verified**. The fresh **98-file** build passed in **40m55s** (2454.734 seconds), at **11.90 GiB** peak process-tree private memory. The installed-source recheck brings combined verification to **41m03s** (2462.530 seconds).
...
The row has 21,579,702 source bytes. All interval data, coloring,
assembly, and the catalogue example are counted in the fresh run. See
[the verification record](../lean/docs/ATLAS188_VERIFICATION_PROGRESS.md).
