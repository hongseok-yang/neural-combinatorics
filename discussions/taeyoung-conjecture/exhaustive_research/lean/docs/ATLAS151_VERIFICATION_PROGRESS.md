# Atlas151 compact verification record

Atlas151 is **verified** (2026-09-22). The fresh **97-file** build passed in **46m04s** (2764.453 seconds), at **11.83 GiB** peak process-tree private memory. The installed-source recheck brings combined verification to **46m13s** (2773.140 seconds).
...
- `verification_runs/atlas151/fresh_row_1/manifest.json` and `summary.json`.
- `verification_runs/atlas151/fresh_row_1/catalogue_compile.log`.
- `verification_runs/atlas151/installed_example_1.json` and `.log`.
- `verification_runs/atlas151/completed_row.json`.
...
See [the certificate explanation](../../notes/atlas151_compact_certificate.md).
