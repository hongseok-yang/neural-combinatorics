import Taeyoung.Examples.Graph127
import Taeyoung.Examples.Graph153
import Taeyoung.Examples.Graph174
import Taeyoung.Examples.Graph171
...
import Taeyoung.Examples.Graph203
import Taeyoung.Examples.Graph130
import Taeyoung.Examples.Graph199
import Taeyoung.Examples.Graph185
import Taeyoung.Examples.Graph194
import Taeyoung.Examples.Graph169
import Taeyoung.Examples.Graph157
import Taeyoung.Examples.Graph181
import Taeyoung.Examples.Graph124
...
/-! Atlas124: complete compact integer SOS verification; see `docs/ATLAS124_VERIFICATION_PROGRESS.md`. -/
#print axioms Taeyoung.Examples.Graph124.status

/-! Atlas181: complete compact integer SOS verification; see `docs/ATLAS181_VERIFICATION_PROGRESS.md`. -/
#print axioms Taeyoung.Examples.Graph181.status

/-! Atlas157: complete compact integer SOS verification; see `docs/ATLAS157_VERIFICATION_PROGRESS.md`. -/
#print axioms Taeyoung.Examples.Graph157.status

/-! Atlas169: complete compact integer SOS verification; see `docs/ATLAS169_VERIFICATION_PROGRESS.md`. -/
#print axioms Taeyoung.Examples.Graph169.status

/-! Atlas194: complete compact integer SOS verification; see `docs/ATLAS194_VERIFICATION_PROGRESS.md`. -/
#print axioms Taeyoung.Examples.Graph194.status

/-! Atlas185: complete compact integer SOS verification; see `docs/ATLAS185_VERIFICATION_PROGRESS.md`. -/
#print axioms Taeyoung.Examples.Graph185.status

/-! Atlas199: complete compact integer SOS verification; see `docs/ATLAS199_VERIFICATION_PROGRESS.md`. -/
#print axioms Taeyoung.Examples.Graph199.status

/-! Atlas130: complete compact integer SOS verification; see `docs/ATLAS130_VERIFICATION_PROGRESS.md`. -/
#print axioms Taeyoung.Examples.Graph130.status

/-! Atlas203: complete compact integer SOS verification; see `docs/ATLAS203_VERIFICATION_PROGRESS.md`. -/
#print axioms Taeyoung.Examples.Graph203.status

/-! Atlas147: complete compact integer SOS verification; see `docs/ATLAS147_VERIFICATION_PROGRESS.md`. -/
#print axioms Taeyoung.Examples.Graph147.status

/-! Atlas168: complete compact integer SOS verification; see `docs/ATLAS168_VERIFICATION_PROGRESS.md`. -/
...
/-! Atlas171: complete compact integer SOS verification; see `docs/ATLAS171_VERIFICATION_PROGRESS.md`. -/
#print axioms Taeyoung.Examples.Graph171.status

/-! Atlas174: complete compact integer SOS verification; see `docs/ATLAS174_VERIFICATION_PROGRESS.md`. -/
#print axioms Taeyoung.Examples.Graph174.status

/-! Atlas153: complete compact integer SOS verification; see `docs/ATLAS153_VERIFICATION_PROGRESS.md`. -/
#print axioms Taeyoung.Examples.Graph153.status

/-! Atlas127: complete compact integer SOS verification; see `docs/ATLAS127_VERIFICATION_PROGRESS.md`. -/
#print axioms Taeyoung.Examples.Graph127.status
