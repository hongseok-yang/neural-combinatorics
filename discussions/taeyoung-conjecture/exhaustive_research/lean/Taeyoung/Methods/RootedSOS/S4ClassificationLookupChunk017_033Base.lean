...
import Taeyoung.Methods.RootedSOS.S4ClassificationLookups017_033Data
...
def encodedRow (index : Fin 17) : Nat :=
  (S4ClassificationLookups017_033Data.data[index.1]?).getD 0 |>.natAbs
