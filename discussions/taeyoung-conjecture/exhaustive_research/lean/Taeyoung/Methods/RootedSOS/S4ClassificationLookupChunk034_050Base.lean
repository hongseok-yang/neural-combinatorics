...
import Taeyoung.Methods.RootedSOS.S4ClassificationLookups034_050Data
...
def encodedRow (index : Fin 17) : Nat :=
  (S4ClassificationLookups034_050Data.data[index.1]?).getD 0 |>.natAbs
