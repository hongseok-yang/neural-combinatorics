import Taeyoung.Methods.RootedSOS.CompactS4.Atlas147.Lower.BlockSum0
import Taeyoung.Methods.RootedSOS.CompactS4.Atlas147.Lower.BlockSum1
import Taeyoung.Methods.RootedSOS.CompactS4.Atlas147.Lower.BlockSum2
import Taeyoung.Methods.RootedSOS.CompactS4.Atlas147.Lower.BlockSum3
import Taeyoung.Methods.RootedSOS.CompactS4.Atlas147.Lower.BlockSum4
import Taeyoung.Methods.RootedSOS.CompactS4.Atlas147.Lower.Contraction
import Taeyoung.Methods.RootedSOS.CompactS4.Atlas147.Lower.Interval
...
theorem graphon_bound (W : Graphon Ω μ)
  ...
  have ht : 7776*target147 (cliqueDensity 2 W) = (0)*s^0 + (0)*s^1 + (108)*s^2 + (36)*s^3 + (36)*s^4 + (12)*s^5 := by
    rw [← hp']
    unfold target147
    ring
  nlinarith
