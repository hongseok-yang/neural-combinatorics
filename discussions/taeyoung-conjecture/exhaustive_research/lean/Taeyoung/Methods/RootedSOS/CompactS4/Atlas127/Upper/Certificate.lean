import Taeyoung.Methods.RootedSOS.CompactS4.Atlas127.Upper.BlockSum0
import Taeyoung.Methods.RootedSOS.CompactS4.Atlas127.Upper.BlockSum1
import Taeyoung.Methods.RootedSOS.CompactS4.Atlas127.Upper.BlockSum2
import Taeyoung.Methods.RootedSOS.CompactS4.Atlas127.Upper.BlockSum3
import Taeyoung.Methods.RootedSOS.CompactS4.Atlas127.Upper.BlockSum4
import Taeyoung.Methods.RootedSOS.CompactS4.Atlas127.Upper.Contraction
import Taeyoung.Methods.RootedSOS.CompactS4.Atlas127.Upper.Interval
...
theorem graphon_bound (W : Graphon Ω μ)
  ...
  have ht : 243*target127 (cliqueDensity 2 W) = (10)*s^0 + (49)*s^1 + (82)*s^2 + (62)*s^3 + (32)*s^4 + (8)*s^5 := by
    rw [← hp']
    unfold target127
    ring
  nlinarith
