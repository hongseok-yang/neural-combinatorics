import Taeyoung.Methods.RootedSOS.CompactS4.Atlas168.Upper.BlockSum0
import Taeyoung.Methods.RootedSOS.CompactS4.Atlas168.Upper.BlockSum1
import Taeyoung.Methods.RootedSOS.CompactS4.Atlas168.Upper.BlockSum2
import Taeyoung.Methods.RootedSOS.CompactS4.Atlas168.Upper.BlockSum3
import Taeyoung.Methods.RootedSOS.CompactS4.Atlas168.Upper.BlockSum4
import Taeyoung.Methods.RootedSOS.CompactS4.Atlas168.Upper.Contraction
import Taeyoung.Methods.RootedSOS.CompactS4.Atlas168.Upper.Interval
...
theorem graphon_bound (W : Graphon Ω μ)
  ...
  have ht : 243*target168 (cliqueDensity 2 W) = (4)*s^0 + (22)*s^1 + (52)*s^2 + (77)*s^3 + (68)*s^4 + (20)*s^5 := by
    rw [← hp']
    unfold target168
    ring
  nlinarith
