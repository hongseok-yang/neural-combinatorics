import Taeyoung.Methods.RootedSOS.CompactS4.Atlas151.Upper.BlockSum0
import Taeyoung.Methods.RootedSOS.CompactS4.Atlas151.Upper.BlockSum1
import Taeyoung.Methods.RootedSOS.CompactS4.Atlas151.Upper.BlockSum2
import Taeyoung.Methods.RootedSOS.CompactS4.Atlas151.Upper.BlockSum3
import Taeyoung.Methods.RootedSOS.CompactS4.Atlas151.Upper.BlockSum4
import Taeyoung.Methods.RootedSOS.CompactS4.Atlas151.Upper.Contraction
import Taeyoung.Methods.RootedSOS.CompactS4.Atlas151.Upper.Interval
...
theorem graphon_bound (W : Graphon Ω μ)
    ...
    target151 (cliqueDensity 2 W) ≤ homDensity graph151 W := by
  ...
  have ht : 243*target151 (cliqueDensity 2 W) = (8)*s^0 + (38)*s^1 + (65)*s^2 + (64)*s^3 + (52)*s^4 + (16)*s^5 := by
    rw [← hp']
    unfold target151
    ring
  nlinarith
