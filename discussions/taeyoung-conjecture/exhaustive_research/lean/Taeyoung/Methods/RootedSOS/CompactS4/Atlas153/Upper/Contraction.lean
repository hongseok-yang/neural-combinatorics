import Taeyoung.Methods.RootedSOS.CompactS4.Atlas153.Upper.ContractionChecks0000
import Taeyoung.Methods.RootedSOS.CompactS4.Atlas153.Upper.ContractionChecks0013
import Taeyoung.Methods.RootedSOS.CompactS4.Atlas153.Upper.ContractionChecks0026
import Taeyoung.Methods.RootedSOS.CompactS4.Atlas153.Upper.ContractionChecks0039
import Taeyoung.Methods.RootedSOS.CompactS4.Atlas153.Upper.ContractionChecks0052
import Taeyoung.Methods.RootedSOS.CompactS4.Atlas153.Upper.ContractionChecks0065
import Taeyoung.Methods.RootedSOS.CompactS4.Atlas153.Upper.ContractionChecks0078
import Taeyoung.Methods.RootedSOS.CompactS4.Atlas153.Upper.ContractionChecks0091
import Taeyoung.Methods.RootedSOS.CompactS4.Atlas153.Upper.ContractionChecks0104
import Taeyoung.Methods.RootedSOS.CompactS4.Atlas153.Upper.ContractionChecks0117
import Taeyoung.Methods.RootedSOS.CompactS4.Atlas153.Upper.ContractionChecks0130
...
theorem groupTotal_exact (g : Fin 143) (u : Fin 4) :
  ...
  have h := packed_rect_product_exact
    ...
    right groupTotal 576 4534927005674880 15202526499664013721600 30405052999328027443201 rightEncoded
    (by
      intro i j
    ...
    (by
      intro g
      have hoff : (15202526499664013721600 : Int) * geometricEncoding 30405052999328027443201 4 = 427319846212454624615540226264620984936561726731219728849781056967160894448111011669606400 := by decide +kernel
