import Taeyoung.Methods.RootedSOS.CompactS4.Atlas188.Upper.BlockSum0
import Taeyoung.Methods.RootedSOS.CompactS4.Atlas188.Upper.BlockSum1
import Taeyoung.Methods.RootedSOS.CompactS4.Atlas188.Upper.BlockSum2
import Taeyoung.Methods.RootedSOS.CompactS4.Atlas188.Upper.BlockSum3
import Taeyoung.Methods.RootedSOS.CompactS4.Atlas188.Upper.BlockSum4
import Taeyoung.Methods.RootedSOS.CompactS4.Atlas188.Upper.Contraction
import Taeyoung.Methods.RootedSOS.CompactS4.Atlas188.Upper.Interval
...
theorem graphon_bound (W : Graphon Ω μ)
  ...
  have ht : 243*target188 (cliqueDensity 2 W) = (2)*s^0 + (17)*s^1 + (38)*s^2 + (61)*s^3 + (91)*s^4 + (34)*s^5 := by
    rw [← hp']
    unfold target188
    ring
  nlinarith
