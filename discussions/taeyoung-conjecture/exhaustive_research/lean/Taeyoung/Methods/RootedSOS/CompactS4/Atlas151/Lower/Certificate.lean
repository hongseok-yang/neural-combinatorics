import Taeyoung.Methods.RootedSOS.CompactS4.Atlas151.Lower.BlockSum0
import Taeyoung.Methods.RootedSOS.CompactS4.Atlas151.Lower.BlockSum1
import Taeyoung.Methods.RootedSOS.CompactS4.Atlas151.Lower.BlockSum2
import Taeyoung.Methods.RootedSOS.CompactS4.Atlas151.Lower.BlockSum3
import Taeyoung.Methods.RootedSOS.CompactS4.Atlas151.Lower.BlockSum4
import Taeyoung.Methods.RootedSOS.CompactS4.Atlas151.Lower.Contraction
import Taeyoung.Methods.RootedSOS.CompactS4.Atlas151.Lower.Interval
...
theorem graphon_bound (W : Graphon Ω μ)
  ...
  have ht : 7776*target151 (cliqueDensity 2 W) = (0)*s^0 + (0)*s^1 + (216)*s^2 + (0)*s^3 + (24)*s^4 + (16)*s^5 := by
    rw [← hp']
    unfold target151
    ring
  nlinarith
