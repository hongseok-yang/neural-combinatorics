import Taeyoung.Methods.RootedSOS.CompactS4.Atlas194.BlockSum0
import Taeyoung.Methods.RootedSOS.CompactS4.Atlas194.BlockSum1
import Taeyoung.Methods.RootedSOS.CompactS4.Atlas194.BlockSum2
import Taeyoung.Methods.RootedSOS.CompactS4.Atlas194.BlockSum3
import Taeyoung.Methods.RootedSOS.CompactS4.Atlas194.BlockSum4
import Taeyoung.Methods.RootedSOS.CompactS4.Atlas194.Contraction
import Taeyoung.Methods.RootedSOS.CompactS4.Atlas194.Interval
...
theorem graphon_bound (W : Graphon Ω μ) (hp : (2 : Real)/3 ≤ cliqueDensity 2 W) :
    target194 (cliqueDensity 2 W) ≤ homDensity graph194 W := by
  ...
  have ht := target194_interval s
  rw [hp'] at ht
  have ht' : 81*target194 (cliqueDensity 2 W) = (0)*s^0 + (2)*s^1 + (7)*s^2 + (21)*s^3 + (37)*s^4 + (14)*s^5 := by
    rw [ht]
    ring
  nlinarith

theorem satisfiesLowerBound_194 : Taeyoung.SatisfiesLowerBound graph194 :=
  satisfiesLowerBound_194_of_bound (fun W hp => graphon_bound W hp)

#print axioms satisfiesLowerBound_194
