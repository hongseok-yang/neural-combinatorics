import Taeyoung.Methods.RootedSOS.CompactS4.Atlas118.Block07PSD
import Taeyoung.Methods.RootedSOS.CompactS4.Atlas118.Block07Expansion
...
theorem density_nonneg (W : Taeyoung.Graphon Ω μ) (s : Real) : 0 ≤ density W s := by
  have h := integer_flag_density_nonneg (order := 1) (n := 27)
