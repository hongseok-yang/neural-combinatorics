...
import Taeyoung.Methods.RootedSOS.CompactS4.Atlas147.Coloring
...
theorem target_core : S4Classification.coreGraph6 95 = graph147 :=
...
def targetCoefficient (r : Fin 143) (j : Fin 6) : Int :=
  (if r = 95 then (if j = 0 then 7776*15552000000000000 else 0) else 0) -
  (if r = 0 then 15552000000000000 *
    (if j = 0 then (0) else if j = 1 then (0) else if j = 2 then (108) else if j = 3 then (36) else if j = 4 then (36) else (12)) else 0)
