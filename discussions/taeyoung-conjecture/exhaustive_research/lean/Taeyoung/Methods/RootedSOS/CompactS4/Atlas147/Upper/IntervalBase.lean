...
def targetCoefficient (r : Fin 143) (j : Fin 6) : Int :=
  (if r = 95 then (if j = 0 then 243*7776000000000000 else 0) else 0) -
  (if r = 0 then 7776000000000000 *
    (if j = 0 then (6) else if j = 1 then (33) else if j = 2 then (69) else if j = 3 then (75) else if j = 4 then (48) else (12)) else 0)
