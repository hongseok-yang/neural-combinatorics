...
def targetCoefficient (r : Fin 143) (j : Fin 6) : Int :=
  (if r = 101 then (if j = 0 then 243*11664000000000000 else 0) else 0) -
  (if r = 0 then 11664000000000000 *
    (if j = 0 then (4) else if j = 1 then (34) else if j = 2 then (76) else if j = 3 then (68) else if j = 4 then (47) else (14)) else 0)
