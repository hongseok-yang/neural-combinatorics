import Taeyoung.Methods.RootedSOS.CompactS4.Atlas130.BlockSum0
import Taeyoung.Methods.RootedSOS.CompactS4.Atlas130.BlockSum1
import Taeyoung.Methods.RootedSOS.CompactS4.Atlas130.BlockSum2
import Taeyoung.Methods.RootedSOS.CompactS4.Atlas130.BlockSum3
import Taeyoung.Methods.RootedSOS.CompactS4.Atlas130.BlockSum4
import Taeyoung.Methods.RootedSOS.CompactS4.Atlas130.Contraction
import Taeyoung.Methods.RootedSOS.CompactS4.Atlas130.Interval
...
theorem upper_graphon_bound (W : Graphon Ω μ) (hp : (2 : Real)/3 ≤ cliqueDensity 2 W) :
  ...
  have ht := target130_interval s
  rw [hp'] at ht
  have ht' : 243*target130 (cliqueDensity 2 W) = (8)*s^0 + (44)*s^1 + (86)*s^2 + (73)*s^3 + (28)*s^4 + (4)*s^5 := by
    rw [ht]
    ring
  nlinarith
