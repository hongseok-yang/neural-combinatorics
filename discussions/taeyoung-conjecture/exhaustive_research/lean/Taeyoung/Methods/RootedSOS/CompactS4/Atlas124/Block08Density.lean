import Taeyoung.Methods.RootedSOS.CompactS4.Atlas124.Block08PSD
import Taeyoung.Methods.RootedSOS.CompactS4.Atlas124.Block08Expansion
...
theorem density_nonneg (W : Taeyoung.Graphon Ω μ) (s : Real) : 0 ≤ density W s := by
  have h := integer_flag_density_nonneg (order := 1) (n := 29)
