...
import Taeyoung.Methods.RootedSOS.CompactS4.Atlas124.Coloring
...
theorem target_core : S4Classification.coreGraph6 74 = graph124 :=
...
def targetCoefficient (r : Fin 143) (j : Fin 6) : Int :=
  (if r = 74 then (if j = 0 then 16*10368000000000000 else 0) else 0) -
