import Taeyoung.Methods.RootedSOS.CompactS4.Atlas171.Middle.ContractionBase
namespace Taeyoung.Methods.RootedSOS.CompactS4.Atlas171.Middle
set_option maxRecDepth 1000000
set_option maxHeartbeats 40000000
private theorem check_0130 : ∀ i : Fin 1,
    contractionCheck ⟨130+i.1, by omega⟩ := by decide +kernel
private theorem check_0131 : ∀ i : Fin 1,
    contractionCheck ⟨131+i.1, by omega⟩ := by decide +kernel
private theorem check_0132 : ∀ i : Fin 1,
    contractionCheck ⟨132+i.1, by omega⟩ := by decide +kernel
private theorem check_0133 : ∀ i : Fin 1,
    contractionCheck ⟨133+i.1, by omega⟩ := by decide +kernel
private theorem check_0134 : ∀ i : Fin 1,
    contractionCheck ⟨134+i.1, by omega⟩ := by decide +kernel
private theorem check_0135 : ∀ i : Fin 1,
    contractionCheck ⟨135+i.1, by omega⟩ := by decide +kernel
private theorem check_0136 : ∀ i : Fin 1,
    contractionCheck ⟨136+i.1, by omega⟩ := by decide +kernel
private theorem check_0137 : ∀ i : Fin 1,
    contractionCheck ⟨137+i.1, by omega⟩ := by decide +kernel
private theorem check_0138 : ∀ i : Fin 1,
    contractionCheck ⟨138+i.1, by omega⟩ := by decide +kernel
private theorem check_0139 : ∀ i : Fin 1,
    contractionCheck ⟨139+i.1, by omega⟩ := by decide +kernel
private theorem check_0140 : ∀ i : Fin 1,
    contractionCheck ⟨140+i.1, by omega⟩ := by decide +kernel
private theorem check_0141 : ∀ i : Fin 1,
    contractionCheck ⟨141+i.1, by omega⟩ := by decide +kernel
private theorem check_0142 : ∀ i : Fin 1,
    contractionCheck ⟨142+i.1, by omega⟩ := by decide +kernel
theorem ContractionChecks_0130 (i : Fin 13) : contractionCheck ⟨130+i.1, by omega⟩ := by
  by_cases h : i.1 < 1
