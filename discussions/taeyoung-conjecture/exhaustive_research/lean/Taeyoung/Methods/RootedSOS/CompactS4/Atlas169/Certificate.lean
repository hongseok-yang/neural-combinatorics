import Taeyoung.Methods.RootedSOS.CompactS4.Atlas169.BlockSum0
import Taeyoung.Methods.RootedSOS.CompactS4.Atlas169.BlockSum1
import Taeyoung.Methods.RootedSOS.CompactS4.Atlas169.BlockSum2
import Taeyoung.Methods.RootedSOS.CompactS4.Atlas169.BlockSum3
import Taeyoung.Methods.RootedSOS.CompactS4.Atlas169.BlockSum4
import Taeyoung.Methods.RootedSOS.CompactS4.Atlas169.Contraction
import Taeyoung.Methods.RootedSOS.CompactS4.Atlas169.Interval
...
theorem graphon_bound (W : Graphon Ω μ) (hp : (2 : Real)/3 ≤ cliqueDensity 2 W) :
    target169 (cliqueDensity 2 W) ≤ homDensity graph169 W := by
  ...
  have ht := target169_interval s
  rw [hp'] at ht
  have ht' : 81*target169 (cliqueDensity 2 W) = (0)*s^0 + (6)*s^1 + (21)*s^2 + (27)*s^3 + (21)*s^4 + (6)*s^5 := by
    rw [ht]
    ring
  nlinarith

theorem satisfiesLowerBound_169 : Taeyoung.SatisfiesLowerBound graph169 :=
  satisfiesLowerBound_169_of_bound (fun W hp => graphon_bound W hp)

#print axioms satisfiesLowerBound_169
