...
theorem target_core : S4Classification.coreGraph6 101 = graph153 :=
...
def targetCoefficient (r : Fin 143) (j : Fin 6) : Int :=
  (if r = 101 then (if j = 0 then 759375*6065280000000000000 else 0) else 0) -
  (if r = 0 then 6065280000000000000 *
    (if j = 0 then (-729) else if j = 1 then (6480) else if j = 2 then (5670) else if j = 3 then (900) else if j = 4 then (165) else (14)) else 0)
