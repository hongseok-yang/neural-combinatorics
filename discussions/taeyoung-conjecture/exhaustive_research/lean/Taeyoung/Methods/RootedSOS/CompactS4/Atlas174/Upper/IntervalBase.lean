...
def targetCoefficient (r : Fin 143) (j : Fin 6) : Int :=
  (if r = 120 then (if j = 0 then 243*23328000000000000 else 0) else 0) -
  (if r = 0 then 23328000000000000 *
    (if j = 0 then (4) else if j = 1 then (28) else if j = 2 then (55) else if j = 3 then (59) else if j = 4 then (71) else (26)) else 0)
