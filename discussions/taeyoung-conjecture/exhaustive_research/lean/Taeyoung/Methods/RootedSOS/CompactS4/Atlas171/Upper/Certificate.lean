import Taeyoung.Methods.RootedSOS.CompactS4.Atlas171.Upper.BlockSum0
import Taeyoung.Methods.RootedSOS.CompactS4.Atlas171.Upper.BlockSum1
import Taeyoung.Methods.RootedSOS.CompactS4.Atlas171.Upper.BlockSum2
import Taeyoung.Methods.RootedSOS.CompactS4.Atlas171.Upper.BlockSum3
import Taeyoung.Methods.RootedSOS.CompactS4.Atlas171.Upper.BlockSum4
import Taeyoung.Methods.RootedSOS.CompactS4.Atlas171.Upper.Contraction
import Taeyoung.Methods.RootedSOS.CompactS4.Atlas171.Upper.Interval
...
theorem graphon_bound (W : Graphon Ω μ)
  ...
  have ht : 243*target171 (cliqueDensity 2 W) = (2)*s^0 + (23)*s^1 + (59)*s^2 + (70)*s^3 + (67)*s^4 + (22)*s^5 := by
    rw [← hp']
    unfold target171
    ring
  nlinarith
