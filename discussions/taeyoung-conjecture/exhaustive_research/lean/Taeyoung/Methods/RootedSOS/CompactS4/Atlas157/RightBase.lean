import Taeyoung.Methods.RootedSOS.CompactS4.Atlas157.RightData
import Taeyoung.Methods.RootedSOS.CompactS4.Atlas157.Block00ExpansionData
import Taeyoung.Methods.RootedSOS.CompactS4.Atlas157.Block01ExpansionData
import Taeyoung.Methods.RootedSOS.CompactS4.Atlas157.Block02ExpansionData
import Taeyoung.Methods.RootedSOS.CompactS4.Atlas157.Block03ExpansionData
import Taeyoung.Methods.RootedSOS.CompactS4.Atlas157.Block04ExpansionData
import Taeyoung.Methods.RootedSOS.CompactS4.Atlas157.Block05ExpansionData
import Taeyoung.Methods.RootedSOS.CompactS4.Atlas157.Block06ExpansionData
import Taeyoung.Methods.RootedSOS.CompactS4.Atlas157.Block07ExpansionData
import Taeyoung.Methods.RootedSOS.CompactS4.Atlas157.Block08ExpansionData
...
def rightCheck (k : Fin 5820) : Prop :=
  (∀ u : Fin 4, (right k u).natAbs ≤ 526165453421568 ∧ right k u = expandedRight k u) ∧
  rightEncoded k = ∑ u : Fin 4, right k u * (3527749945628381675521 : Int)^u.1
