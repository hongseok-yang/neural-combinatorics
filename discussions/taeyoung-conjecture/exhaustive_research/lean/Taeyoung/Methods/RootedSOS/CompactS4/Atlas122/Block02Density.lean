import Taeyoung.Methods.RootedSOS.CompactS4.Atlas122.Block02PSD
import Taeyoung.Methods.RootedSOS.CompactS4.Atlas122.Block02Expansion
...
theorem density_nonneg (W : Taeyoung.Graphon Ω μ) (s : Real) : 0 ≤ density W s := by
  have h := integer_flag_density_nonneg (order := 2) (n := 58)
