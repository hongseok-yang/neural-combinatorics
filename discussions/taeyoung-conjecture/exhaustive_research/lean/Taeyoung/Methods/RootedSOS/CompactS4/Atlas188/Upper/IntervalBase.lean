...
def targetCoefficient (r : Fin 143) (j : Fin 6) : Int :=
  (if r = 132 then (if j = 0 then 243*23328000000000000 else 0) else 0) -
  (if r = 0 then 23328000000000000 *
    (if j = 0 then (2) else if j = 1 then (17) else if j = 2 then (38) else if j = 3 then (61) else if j = 4 then (91) else (34)) else 0)
