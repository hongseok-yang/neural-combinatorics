...
namespace Taeyoung.Methods.RootedSOS.CompactS4.Atlas151.Lower.Block02
...
theorem density_nonneg (W : Taeyoung.Graphon Ω μ) (s : Real) : 0 ≤ density W s := by
  have h := integer_flag_density_nonneg (order := 2) (n := 65)
...
end Taeyoung.Methods.RootedSOS.CompactS4.Atlas151.Lower.Block02
