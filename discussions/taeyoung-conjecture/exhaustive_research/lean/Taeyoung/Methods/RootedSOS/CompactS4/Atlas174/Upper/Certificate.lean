import Taeyoung.Methods.RootedSOS.CompactS4.Atlas174.Upper.BlockSum0
import Taeyoung.Methods.RootedSOS.CompactS4.Atlas174.Upper.BlockSum1
import Taeyoung.Methods.RootedSOS.CompactS4.Atlas174.Upper.BlockSum2
import Taeyoung.Methods.RootedSOS.CompactS4.Atlas174.Upper.BlockSum3
import Taeyoung.Methods.RootedSOS.CompactS4.Atlas174.Upper.BlockSum4
import Taeyoung.Methods.RootedSOS.CompactS4.Atlas174.Upper.Contraction
import Taeyoung.Methods.RootedSOS.CompactS4.Atlas174.Upper.Interval
...
theorem graphon_bound (W : Graphon Ω μ)
  ...
  have ht : 243*target174 (cliqueDensity 2 W) = (4)*s^0 + (28)*s^1 + (55)*s^2 + (59)*s^3 + (71)*s^4 + (26)*s^5 := by
    rw [← hp']
    unfold target174
    ring
  nlinarith
