import Taeyoung.Methods.RootedSOS.CompactS4.Atlas147.Upper.BlockSum0
import Taeyoung.Methods.RootedSOS.CompactS4.Atlas147.Upper.BlockSum1
import Taeyoung.Methods.RootedSOS.CompactS4.Atlas147.Upper.BlockSum2
import Taeyoung.Methods.RootedSOS.CompactS4.Atlas147.Upper.BlockSum3
import Taeyoung.Methods.RootedSOS.CompactS4.Atlas147.Upper.BlockSum4
import Taeyoung.Methods.RootedSOS.CompactS4.Atlas147.Upper.Contraction
import Taeyoung.Methods.RootedSOS.CompactS4.Atlas147.Upper.Interval
...
theorem graphon_bound (W : Graphon Ω μ)
  ...
  have ht : 243*target147 (cliqueDensity 2 W) = (6)*s^0 + (33)*s^1 + (69)*s^2 + (75)*s^3 + (48)*s^4 + (12)*s^5 := by
    rw [← hp']
    unfold target147
    ring
  nlinarith
