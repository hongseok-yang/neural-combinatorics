import Taeyoung.Methods.RootedSOS.CompactS4.Atlas188.Middle.BlockSum0
import Taeyoung.Methods.RootedSOS.CompactS4.Atlas188.Middle.BlockSum1
import Taeyoung.Methods.RootedSOS.CompactS4.Atlas188.Middle.BlockSum2
import Taeyoung.Methods.RootedSOS.CompactS4.Atlas188.Middle.BlockSum3
import Taeyoung.Methods.RootedSOS.CompactS4.Atlas188.Middle.BlockSum4
import Taeyoung.Methods.RootedSOS.CompactS4.Atlas188.Middle.Contraction
import Taeyoung.Methods.RootedSOS.CompactS4.Atlas188.Middle.Interval
...
theorem graphon_bound (W : Graphon Ω μ)
  ...
  have ht : 759375*target188 (cliqueDensity 2 W) = (-729)*s^0 + (4050)*s^1 + (2565)*s^2 + (45)*s^3 + (285)*s^4 + (34)*s^5 := by
    rw [← hp']
    unfold target188
    ring
  nlinarith
