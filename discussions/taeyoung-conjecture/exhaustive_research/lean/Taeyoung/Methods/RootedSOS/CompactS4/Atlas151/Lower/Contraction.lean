import Taeyoung.Methods.RootedSOS.CompactS4.Atlas151.Lower.ContractionChecks0000
import Taeyoung.Methods.RootedSOS.CompactS4.Atlas151.Lower.ContractionChecks0013
import Taeyoung.Methods.RootedSOS.CompactS4.Atlas151.Lower.ContractionChecks0026
import Taeyoung.Methods.RootedSOS.CompactS4.Atlas151.Lower.ContractionChecks0039
import Taeyoung.Methods.RootedSOS.CompactS4.Atlas151.Lower.ContractionChecks0052
import Taeyoung.Methods.RootedSOS.CompactS4.Atlas151.Lower.ContractionChecks0065
import Taeyoung.Methods.RootedSOS.CompactS4.Atlas151.Lower.ContractionChecks0078
import Taeyoung.Methods.RootedSOS.CompactS4.Atlas151.Lower.ContractionChecks0091
import Taeyoung.Methods.RootedSOS.CompactS4.Atlas151.Lower.ContractionChecks0104
import Taeyoung.Methods.RootedSOS.CompactS4.Atlas151.Lower.ContractionChecks0117
import Taeyoung.Methods.RootedSOS.CompactS4.Atlas151.Lower.ContractionChecks0130
...
theorem groupTotal_exact (g : Fin 143) (u : Fin 4) :
  ...
  have h := packed_rect_product_exact
    ...
    right groupTotal 576 33034720099424256 110742952883701921873920 221485905767403843747841 rightEncoded
    (by
      intro i j
    ...
    (by
      intro g
      have hoff : (110742952883701921873920 : Int) * geometricEncoding 221485905767403843747841 4 = 1203245884588180300545333680950775157210102919442695835137109851242536614233429886443957780480 := by decide +kernel
