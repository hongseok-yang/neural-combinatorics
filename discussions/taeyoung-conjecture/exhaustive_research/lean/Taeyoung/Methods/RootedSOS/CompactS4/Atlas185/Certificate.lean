import Taeyoung.Methods.RootedSOS.CompactS4.Atlas185.BlockSum0
import Taeyoung.Methods.RootedSOS.CompactS4.Atlas185.BlockSum1
import Taeyoung.Methods.RootedSOS.CompactS4.Atlas185.BlockSum2
import Taeyoung.Methods.RootedSOS.CompactS4.Atlas185.BlockSum3
import Taeyoung.Methods.RootedSOS.CompactS4.Atlas185.BlockSum4
import Taeyoung.Methods.RootedSOS.CompactS4.Atlas185.Contraction
import Taeyoung.Methods.RootedSOS.CompactS4.Atlas185.Interval
...
theorem graphon_bound (W : Graphon Ω μ) (hp : (2 : Real)/3 ≤ cliqueDensity 2 W) :
    target185 (cliqueDensity 2 W) ≤ homDensity graph185 W := by
  ...
  have ht := target185_interval s
  rw [hp'] at ht
  have ht' : 81*target185 (cliqueDensity 2 W) = (0)*s^0 + (4)*s^1 + (14)*s^2 + (24)*s^3 + (29)*s^4 + (10)*s^5 := by
    rw [ht]
    ring
  nlinarith

theorem satisfiesLowerBound_185 : Taeyoung.SatisfiesLowerBound graph185 :=
  satisfiesLowerBound_185_of_bound (fun W hp => graphon_bound W hp)

#print axioms satisfiesLowerBound_185
