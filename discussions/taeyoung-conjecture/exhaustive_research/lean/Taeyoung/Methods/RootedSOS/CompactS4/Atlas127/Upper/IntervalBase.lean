...
def targetCoefficient (r : Fin 143) (j : Fin 6) : Int :=
  (if r = 77 then (if j = 0 then 243*23328000000000000 else 0) else 0) -
  (if r = 0 then 23328000000000000 *
    (if j = 0 then (10) else if j = 1 then (49) else if j = 2 then (82) else if j = 3 then (62) else if j = 4 then (32) else (8)) else 0)
