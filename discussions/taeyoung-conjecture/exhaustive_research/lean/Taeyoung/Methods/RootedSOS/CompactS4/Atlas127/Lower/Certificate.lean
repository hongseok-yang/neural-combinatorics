import Taeyoung.Methods.RootedSOS.CompactS4.Atlas127.Lower.BlockSum0
import Taeyoung.Methods.RootedSOS.CompactS4.Atlas127.Lower.BlockSum1
import Taeyoung.Methods.RootedSOS.CompactS4.Atlas127.Lower.BlockSum2
import Taeyoung.Methods.RootedSOS.CompactS4.Atlas127.Lower.BlockSum3
import Taeyoung.Methods.RootedSOS.CompactS4.Atlas127.Lower.BlockSum4
import Taeyoung.Methods.RootedSOS.CompactS4.Atlas127.Lower.Contraction
import Taeyoung.Methods.RootedSOS.CompactS4.Atlas127.Lower.Interval
...
theorem graphon_bound (W : Graphon Ω μ)
  ...
  have ht : 7776*target127 (cliqueDensity 2 W) = (0)*s^0 + (0)*s^1 + (216)*s^2 + (72)*s^3 + (24)*s^4 + (8)*s^5 := by
    rw [← hp']
    unfold target127
    ring
  nlinarith
