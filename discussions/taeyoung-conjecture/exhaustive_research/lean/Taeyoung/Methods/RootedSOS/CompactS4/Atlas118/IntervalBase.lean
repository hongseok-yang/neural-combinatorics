...
import Taeyoung.Methods.RootedSOS.CompactS4.Atlas118.Coloring
...
theorem target_core : S4Classification.coreGraph6 68 = graph118 :=
...
def targetCoefficient (r : Fin 143) (j : Fin 6) : Int :=
  (if r = 68 then (if j = 0 then 16*5184000000000000 else 0) else 0) -
  (if r = 0 then 5184000000000000 *
