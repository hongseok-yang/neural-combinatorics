...
/-!
# Atlas 191: verified clique common-leaf example

graph6: `E~|?`.  The edge-list definition below is the Lean graph;
...
namespace Taeyoung.Examples.Graph191

open Taeyoung

def graph : SimpleGraph (Fin 6) :=
  graphFromEdges 6 [(0, 1), (0, 2), (0, 3), (0, 4), (1, 2), (1, 3), (1, 4), (1, 5), (2, 3), (2, 4), (3, 4)]
...
theorem iso_adj (a b : Fin 6) :
    graph.Adj (relabel a) (relabel b) ↔
      (Taeyoung.Methods.CliqueLeaf.cliqueLeafGraph 2 1).Adj a b := by
  revert a b
  decide

/-- The certificate representative is this Atlas graph, up to relabelling. -/
def iso : (Taeyoung.Methods.CliqueLeaf.cliqueLeafGraph 2 1) ≃g graph where
  toEquiv := relabel
...
theorem status : SatisfiesLowerBound graph :=
  SatisfiesLowerBound.of_iso iso
    (Taeyoung.Methods.CliqueLeaf.satisfiesLowerBound_51)

end Taeyoung.Examples.Graph191
