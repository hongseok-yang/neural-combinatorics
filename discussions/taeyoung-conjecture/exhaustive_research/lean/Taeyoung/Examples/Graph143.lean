...
/-!
# Atlas 143: verified tensor-Turán counterexample

graph6: `Er`o`.  The edge-list definition below is the Lean graph;
...
namespace Taeyoung.Examples.Graph143

open Taeyoung Taeyoung.Methods.Negative

def graph : SimpleGraph (Fin 6) :=
  graphFromEdges 6 [(0, 1), (0, 2), (0, 4), (1, 3), (1, 5), (2, 3), (2, 5), (3, 5)]
...
end Taeyoung.Examples.Graph143
