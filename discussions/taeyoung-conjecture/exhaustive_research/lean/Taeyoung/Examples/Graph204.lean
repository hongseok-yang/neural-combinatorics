...
/-!
# Atlas 204: verified tensor-Turán counterexample

graph6: `EznW`.  The edge-list definition below is the Lean graph;
...
```
t = χ_H(4)·χ_H(6) / 24^6 = 85/41472,
Φ = (1 - p)^6·χ_H(1/(1-p))   = 5/2048,
```
...
namespace Taeyoung.Examples.Graph204

open Taeyoung Taeyoung.Methods.Negative

def graph : SimpleGraph (Fin 6) :=
  graphFromEdges 6 [(0, 1), (0, 2), (0, 4), (0, 5), (1, 2), (1, 3), (1, 5), (2, 3), (2, 4), (3, 4), (3, 5), (4, 5)]
...
theorem surj_5 : surjCount graph 5 = 360 := by decide +kernel
...
theorem count (k : ℕ) :
    properAssignmentCount graph k = 6 * k.choose 3 + 72 * k.choose 4 + 360 * k.choose 5 + 720 * k.choose 6 := by
...
/-- `χ_H(4) = 96`, the first tensor factor. -/
theorem count_4 : properAssignmentCount graph 4 = 96 := by
  rw [count]
  decide

/-- `χ_H(6) = 4080`, the second tensor factor. -/
theorem count_6 : properAssignmentCount graph 6 = 4080 := by
  rw [count]
  decide
...
end Taeyoung.Examples.Graph204
