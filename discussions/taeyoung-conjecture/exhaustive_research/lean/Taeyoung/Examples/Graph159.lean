...
/-!
# Atlas 159: verified tensor-Turán counterexample

graph6: `EZSw`.  The edge-list definition below is the Lean graph;
...
```
t = χ_H(3)·χ_H(5) / 15^6 = 448/253125,
Φ = (1 - p)^6·χ_H(1/(1-p))   = 2752/759375,
```
...
namespace Taeyoung.Examples.Graph159

open Taeyoung Taeyoung.Methods.Negative

def graph : SimpleGraph (Fin 6) :=
  graphFromEdges 6 [(0, 2), (1, 2), (1, 3), (1, 4), (2, 3), (2, 5), (3, 4), (3, 5), (4, 5)]
...
theorem count (k : ℕ) :
    properAssignmentCount graph k = 12 * k.choose 3 + 168 * k.choose 4 + 720 * k.choose 5 + 720 * k.choose 6 := by
...
/-- `χ_H(3) = 12`, the first tensor factor. -/
theorem count_3 : properAssignmentCount graph 3 = 12 := by
  rw [count]
  decide

/-- `χ_H(5) = 1680`, the second tensor factor. -/
theorem count_5 : properAssignmentCount graph 5 = 1680 := by
  rw [count]
  decide
...
end Taeyoung.Examples.Graph159
