...
/-!
# Atlas 186: verified tensor-Turán counterexample

graph6: `ErXw`.  The edge-list definition below is the Lean graph;
...
```
t = χ_H(4)·χ_H(4) / 16^6 = 9/4096,
Φ = (1 - p)^6·χ_H(1/(1-p))   = 99/32768,
```
...
namespace Taeyoung.Examples.Graph186

open Taeyoung Taeyoung.Methods.Negative

def graph : SimpleGraph (Fin 6) :=
  graphFromEdges 6 [(0, 1), (0, 2), (1, 3), (1, 4), (1, 5), (2, 3), (2, 4), (2, 5), (3, 5), (4, 5)]
...
theorem surj_4 : surjCount graph 4 = 144 := by decide +kernel
...
theorem count (k : ℕ) :
    properAssignmentCount graph k = 12 * k.choose 3 + 144 * k.choose 4 + 600 * k.choose 5 + 720 * k.choose 6 := by
...
/-- `χ_H(4) = 192`, the first tensor factor. -/
theorem count_4 : properAssignmentCount graph 4 = 192 := by
  rw [count]
  decide
...
end Taeyoung.Examples.Graph186
