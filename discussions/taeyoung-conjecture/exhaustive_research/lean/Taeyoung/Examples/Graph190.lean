...
/-!
# Atlas 190: verified tensor-Turán counterexample

graph6: `EyUw`.  The edge-list definition below is the Lean graph;
...
namespace Taeyoung.Examples.Graph190

open Taeyoung Taeyoung.Methods.Negative

def graph : SimpleGraph (Fin 6) :=
  graphFromEdges 6 [(0, 1), (0, 2), (0, 5), (1, 2), (1, 3), (1, 4), (2, 5), (3, 4), (3, 5), (4, 5)]
...
end Taeyoung.Examples.Graph190
