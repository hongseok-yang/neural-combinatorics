...
/-!
# Atlas 192: verified forest-cone example

graph6: `E~Xo`.  The edge-list definition below is the Lean graph;
...
namespace Taeyoung.Examples.Graph192

open Taeyoung

def graph : SimpleGraph (Fin 6) :=
  graphFromEdges 6 [(0, 1), (0, 2), (0, 3), (1, 2), (1, 3), (1, 4), (1, 5), (2, 3), (2, 4), (2, 5), (3, 5)]
...
theorem iso_adj (a b : Fin 6) :
    graph.Adj (relabel a) (relabel b) ↔
      (Taeyoung.Methods.Link.coneGraph (Taeyoung.Methods.Link.coneGraph Taeyoung.Methods.ForestCone.starIsolate1)).Adj a b := by
  revert a b
  decide

/-- The certificate representative is this Atlas graph, up to relabelling. -/
def iso : (Taeyoung.Methods.Link.coneGraph (Taeyoung.Methods.Link.coneGraph Taeyoung.Methods.ForestCone.starIsolate1)) ≃g graph where
  toEquiv := relabel
...
theorem status : SatisfiesLowerBound graph :=
  SatisfiesLowerBound.of_iso iso
    (Taeyoung.Methods.ForestCone.satisfiesLowerBound_192)

end Taeyoung.Examples.Graph192
