...
/-!
# Atlas 173: verified tensor-Turán counterexample

graph6: `ElMg`.  The edge-list definition below is the Lean graph;
...
```
t = χ_H(4)·χ_H(6) / 24^6 = 5/384,
Φ = (1 - p)^6·χ_H(1/(1-p))   = 55/4096,
```
...
namespace Taeyoung.Examples.Graph173

open Taeyoung Taeyoung.Methods.Negative

def graph : SimpleGraph (Fin 6) :=
  graphFromEdges 6 [(0, 1), (0, 3), (0, 5), (1, 2), (2, 3), (2, 4), (2, 5), (3, 4), (4, 5)]
...
theorem surj_3 : surjCount graph 3 = 18 := by decide +kernel
...
theorem count (k : ℕ) :
    properAssignmentCount graph k = 18 * k.choose 3 + 216 * k.choose 4 + 720 * k.choose 5 + 720 * k.choose 6 := by
...
/-- `χ_H(4) = 288`, the first tensor factor. -/
theorem count_4 : properAssignmentCount graph 4 = 288 := by
  rw [count]
  decide

/-- `χ_H(6) = 8640`, the second tensor factor. -/
theorem count_6 : properAssignmentCount graph 6 = 8640 := by
  rw [count]
  decide
...
end Taeyoung.Examples.Graph173
