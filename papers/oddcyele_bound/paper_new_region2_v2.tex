...
\end{equation}
and $m\ge9$ is odd.  We continue with the block decomposition
\eqref{eq:block-U} and the operator norm bound of \Cref{lem:half-norm}.  The
second bound on the spectrum of $A$, used only in this section, is the
following.
