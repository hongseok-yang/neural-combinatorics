...
Throughout this section, and in the two that follow, we assume $W$ to be a
step graphon, as \Cref{lem:step-reduction} proves, and all determinants and
traces are taken in the resulting finite-dimensional setting.  Fix a finite
