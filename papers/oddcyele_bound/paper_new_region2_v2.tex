...
\begin{lemma}[No eigenvalue above $q$]\label{lem:no-frontier}
...
\end{equation}
The strict inequality $L>0$ will follow from the variance lower bound
...
\subsection{A variance lower bound and the eigenvalue upper bound}\label{subsec:forced-variance}
