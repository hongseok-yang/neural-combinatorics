...
\begin{proof}
  ...
  \[
    ...
    =\binom{n+2r-1}{2r-1}\frac {n}{r}\E\bigl[XV_X^{n-1}\bigr].
  \]
  ...
  -h_{n-1}(q^{\times(r+1)},\ell^{\times r})$
  and using $\frac {m}{r}=\frac {n}{r}\cdot\frac {m}{n}$ proves
  ...
  \[
    ...
    =x^n\left[\frac {m}{n}\bigl(u^n+(1-u)^n\bigr)-u^{n-1}\right]
    =x^n\rho_{n,m}(u).
  \]
...
\[
  \frac{1}{\Gamma(r)}y^{r-1}e^{-y}\mathbf1_{(0,\infty)}(y).
\]
