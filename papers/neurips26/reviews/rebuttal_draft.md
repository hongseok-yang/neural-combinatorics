...
2. **Standardized seed study.** Use at least 10 seeds for:
   ...
   *Status:* 10 repetitions on \(K_3,p=7/9\) are done (mean \(0.435711\), 95% CI \([0.435705, 0.435718]\)), together with the learning-rate-schedule study (20000 epochs in 1/2/4/8/20 cosine cycles). The open instances (triangle \(\mathbf{(P2)}\) at \(q=0.10\), \(C_7\) at \(p=5/8\), \(H_6\)) are not yet launched — these are the distributions the reviewers weighted most.
