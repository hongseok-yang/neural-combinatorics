...
Concretely, fix $q \in (0,1)$ and let $h_q(W) \coloneqq \int_{[0,1]^2} \mathrm{KL}\bigl(\mathrm{Bern}(W(x,y))\,\|\,\mathrm{Bern}(q)\bigr)\,dx\,dy$, the integrated per-edge KL divergence of $W$ from the base Erd\H{o}s--R\'enyi graphon $W \equiv q$.
