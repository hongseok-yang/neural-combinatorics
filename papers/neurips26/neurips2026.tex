...
\label{eqn:large-deviation-problem}
  ...
  t(K_3,W) = r^3,
\end{equation}
which is equivalent to the inequality-constrained $\inf$ above, since for $r > q$ the unconstrained minimiser of $h_q$ is $W \equiv q$ with $t(K_3, W) = q^3 < r^3$, so the constraint is active at the optimum.
