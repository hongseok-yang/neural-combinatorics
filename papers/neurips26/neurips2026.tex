...
For the upper tail problems, the 2-regular graphs $K_3, C_4, C_5$ shares a close edge densities and the block size, suggesting the same underlying optimisation landscape; while the star $K_{1,3}$ shows a different structure with a much smaller block size.
