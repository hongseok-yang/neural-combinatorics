...
For the quantitative comparison, the one-clique-on-uniform construction $W_{LZ}$ only applies to the upper tail problem for 2-regular graphs, see \Cref{tab:upperdeviationcycle} for the comparison between the relative entropies of the found graphons and the one-clique-on-uniform construction under constraints $t(C_k, W)\ge r^k$, and \Cref{tab:lowerdeviationcycle} for the upper tail problem for $K_{1,3}$ and the lower tail problem for $K_3$. 


\begin{table}[t]
  \centering
  \captionof{table}{Relative-entropy $h_q(W)$ at our learnt graphon ($W_{\mathrm{ours}}$) and at the one-clique-on-uniform construction $W_{\mathrm{LZ}}$ of \citet{lubetzky2015replica}, for \textbf{(P2)} with $H = C_4, C_5$ on $(q,r) \in \{0.05, 0.1\} \times \{0.4, 0.5, 0.6\}$. Lower is better.\label{tab:upperdeviationcycle}}
  {\small
  \begin{tabular}{lcccccc}
    \toprule
    ...
    \midrule
    $h_q(W_{\mathrm{LZ}})$, $H=C_4$    & $0.556049$ & $0.830366$ & $1.144945$ & $0.311239$ & $0.510825$ & $0.750684$ \\
    $h_q(W_{\mathrm{ours}})$, $H=C_4$  & $0.460461$ & $0.725292$ & $1.051539$ & $0.308220$ & $0.506100$ & $0.747289$ \\
    \midrule
    $h_q(W_{\mathrm{LZ}})$, $H=C_5$    & $0.556049$ & $0.830366$ & $1.144945$ & $0.311239$ & $0.510825$ & $0.750684$ \\
    $h_q(W_{\mathrm{ours}})$, $H=C_5$  & $0.460461$ & $0.725292$ & $1.051539$ & $0.308220$ & $0.506100$ & $0.747289$ \\
    \bottomrule
  \end{tabular}
  }
\end{table}
