...
We demonstrate our framework on two families of graphon optimisation problems: \textbf{(P1)} generalised Tur\'an problems from the extremal graph theory, minimising a homomorphism density under a fixed edge-density constraint; and \textbf{(P2)} the variational problems from the large deviation theory of dense random graphs \citep{chatterjee2011large}, minimising a relative-entropy functional under a fixed subgraph-density constraint.
