...
\begin{equation}
  ...
  \label{eqn:mantel}
\end{equation}
asks for an $n$-vertex triangle-free graph that maximises the edge density. Here $K_m$ denotes the complete graph on $m$ vertices, so $K_2$ and $K_3$ represent an edge and a triangle, respectively. Although the answer is the classical theorem of Mantel~\yrcite{mantel1907vraagstuk}, a large family of similar problems involving homomorphism densities remain open~\citep{sidorenko1993correlation, borgs2006counting, razborov2008minimal}.
