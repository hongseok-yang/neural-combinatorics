...
On \textbf{(P1)}, our framework rediscovers nontrivial known optima that previously required substantial human effort~\citep{goodman1959on,bollobas1976relations,lovasz1983on,fisher1989lower,razborov2008minimal}, produces candidate minimisers for open instances such as mimisation of $C_7$-homomorphism density, and through a systematic sweep over small graphs, uncovers, for a six-vertex graph, a previously unreported family of extremal structures that do not match the complete $k$-partite pattern of classical examples.
...
For $p\in\{4/7,5/8\}$, which satisfy $1-1/k<p<1-1/(k+1)$, the learnt graphons (Figs.~\ref{fig:triangledensity-minimisers}d and \ref{fig:triangledensity-minimisers}e) capture the core structure of the known optimal $W_p$.
...
\paragraph{Variational problem from the large deviation theory}
