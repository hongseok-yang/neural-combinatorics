...
\begin{table}[t]
  \centering
  \caption{$K_3$ densities in graphons found by our method, ablations, and non-neural baselines for $K_3$ density minimisation under $t(K_2, W)=7/9$.  \label{tab:ablationstudy}}
  {\small
  \begin{tabular}{ll}
  \toprule
                     & $t(K_3, W)$ \\
