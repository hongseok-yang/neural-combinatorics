...
\item {\bf Theory assumptions and proofs}
    ...
    \item[] Answer: \answerYes{} % Replace by \answerYes{}, \answerNo{}, or \answerNA{}.
    \item[] Justification: We include a supporting lemma (Lemma 3.1) and a complete proof in the supplementary material.
    \item[] Guidelines:
    \begin{itemize}
...
\item {\bf Experimental setting/details}
    ...
    \item[] Answer: \answerYes{} % Replace by \answerYes{}, \answerNo{}, or \answerNA{}.
    \item[] Justification: Section D of the supplementary material describes the hyperparameters and optimiser, and the code reproduces the experiments.
    \item[] Guidelines:
    \begin{itemize}
        \item The answer \answerNA{} means that the paper does not include experiments.
...
\item {\bf Experiment statistical significance}
    ...
    \item[] Answer: \answerYes{} % Replace by \answerYes{}, \answerNo{}, or \answerNA{}.
    \item[] Justification: For experiments that rely on random sampling, we report 95\% confidence intervals.
    \item[] Guidelines:
    \begin{itemize}
        \item The answer \answerNA{} means that the paper does not include experiments.
...
\item {\bf Experiments compute resources}
    ...
    \item[] Answer: \answerYes{} % Replace by \answerYes{}, \answerNo{}, or \answerNA{}.
    \item[] Justification: Section D of the supplementary material reports the compute resources used in our experiments.
    \item[] Guidelines:
    \begin{itemize}
        \item The answer \answerNA{} means that the paper does not include experiments.
...
\item {\bf Broader impacts}
    ...
    \item[] Justification: Our work can help advance graph theory by generating conjectures and counterexamples, and we do not foresee negative societal impacts.
    \item[] Guidelines:
    \begin{itemize}
