...
\tk{Revised up to here. }

Unlike \eqref{eq:plt23-F-formula}, these are not yet written in the tilde variables: they retain $\Lambda$ and $1-2\Lambda$, and the quotients $\Lambda_m/\Lambda^{m-2}$ and $M_m/\Lambda^{m-2}$ formed from the coefficients $\Lambda_m$ and $M_m$ of \eqref{eq:plt23-splitting-lower-bound}.
For $\Lambda$ and $1-2\Lambda$, writing
\[
  \Delta:=\tilde p^2+1+\tilde M^2,
\]
and using $p+q=1$, $p=\tilde p\Lambda$, and $q=(1+\tilde M^2)\Lambda/\tilde p$, they are
\[
  \Lambda=\frac{\tilde p}{\Delta},
  \qquad
  q=\frac{1+\tilde M^2}{\Delta},
  \qquad
  1-2\Lambda=\frac{\delta_{\tilde p}^2+\tilde M^2}{\Delta}.
\]
...
\begin{equation}\label{eq:plt23-QL-Delta}
  \widehat L_m
  =\delta_{\tilde q}(1-\tilde M)\sqrt{\frac{2\tilde p}\Delta}\,
   \frac{M_m}{\Lambda^{m-2}},
  \qquad
  \widehat Q_m
  =\frac{2\tilde p^3\delta_{\tilde q}^2}{\Delta\,(\delta_{\tilde p}^2+\tilde M^2)^2}\,
   \frac{\Lambda_m}{\Lambda^{m-2}},
\end{equation}
where in $\widehat Q_m$ the factor $\Lambda^3$ contributes $\Delta^{-3}$ and $(1-2\Lambda)^{-2}$ contributes $\Delta^2$, leaving a single $\Delta$.
As $\Delta$ is a polynomial in $\tilde p$ and $\tilde M$, the only quantities here that are not tilde variables are $\Lambda_m/\Lambda^{m-2}$ and $M_m/\Lambda^{m-2}$.

For these two, dividing \eqref{eq:plt23-Lambdam-def} and \eqref{eq:plt23-Mm-def} by $\Lambda^{m-2}$ and using \eqref{eq:plt23-km-def} gives
\begin{align}
  \frac{\Lambda_m}{\Lambda^{m-2}}
  &=2\tilde M^{m-2}+mK_\Lambda,
  &
  K_\Lambda
...
\[
  ...
  =\frac{2\tilde p^3\delta_{\tilde q}^2
        ...
        {\Delta\,(\delta_{\tilde p}^2+\tilde M^2)^2},
\]
so that $\widehat R_m$, $\widehat L_m$, and $\widehat Q_m$ are all explicit in $\tilde q$, $\tilde M$, and $\tilde p$.

Three inequalities will be applied to these expressions.
Two bound $\Delta$, the first
\begin{equation}\label{eq:plt23-Delta-upper-sigma}
  \Delta<\tilde p(\delta_{\tilde p}+2),
\end{equation}
which is equivalent to $1+\tilde M^2<\tilde p$, that is, to $\tilde M^2<\delta_{\tilde p}$, and the second, since $q>1/3$,
\begin{equation}\label{eq:plt23-Delta-upper-three}
  \Delta<3(1+\tilde M^2).
\end{equation}
The third bounds $S_m$: it has $(m-1)/2$ summands whose geometric mean is $\tilde p^{(m-3)/2}$, so the arithmetic--geometric mean inequality gives
\begin{equation}\label{eq:plt23-SN-AMGM}
  S_m\ge \frac{m-1}{2}\tilde p^{(m-3)/2}.
\end{equation}

It remains to record the three quantities the two ranges actually compare.
The first is the ratio
\[
  \zeta_q:=\frac{\tilde M^2}{\delta_{\tilde q}}=\frac{M^2}{\Lambda(\Lambda-q)},
\]
in terms of which the tilde variables solve explicitly as
...
The second is
\[
  T_m:=(m-2)-\zeta_q\bigl(\tilde q^{m-2}-\tilde M^{m-2}\bigr).
\]
Because $1-\tilde q^{m-2}\le(m-2)(1-\tilde q)=(m-2)\delta_{\tilde q}$ and $\tilde M^2=\zeta_q\delta_{\tilde q}$, \eqref{eq:plt23-F-formula} gives
\begin{equation}\label{eq:plt23-F-T}
  \widehat R_m\le \delta_{\tilde q}T_m.
\end{equation}
Thus $\widehat R_m\le0$ already proves \eqref{eq:plt23-scalar-target}, because $\psi(\xi,\rho)\ge0$.
...
The third is a common factor: each of $\widehat R_m$, $\widehat Q_m$, and $\widehat L_m$ carries a factor $\delta_{\tilde q}$, by \eqref{eq:plt23-F-T}, \eqref{eq:plt23-Lhat-formula}, and \eqref{eq:plt23-Qhat-formula}, so we set
\[
...
\begin{proof}
  ...
  \begin{align*}
    X
    &=\frac{2\tilde p^3\delta_{\tilde q}}{\Delta\,(\delta_{\tilde p}^2+\tilde M^2)^2}\,
      \frac{\Lambda_m}{\Lambda^{m-2}}\\
    &=\frac{2\tilde p^2(1+z)}
            {\Delta\,\delta_{\tilde p}\,(\delta_{\tilde p}+\tilde pz)^2}\,
      \frac{\Lambda_m}{\Lambda^{m-2}}.
  \end{align*}
  Indeed,
  \[
  ...
  \]
  By \eqref{eq:plt23-KA-def} and \eqref{eq:plt23-KA-sum}, $\Lambda_m/\Lambda^{m-2}\ge m\delta_{\tilde p}S_m$.
  ...
  \end{equation}
  For $Y$, \eqref{eq:plt23-QL-Delta}, \eqref{eq:plt23-KL-def}, and the first term of the sum in \eqref{eq:plt23-KL-sum} give
  \begin{align*}
    Y
    &=(1-\tilde M)\sqrt{\frac{2\tilde p}\Delta}\,
      \frac{M_m}{\Lambda^{m-2}}\\
    &\ge
    m(1-\tilde M)(\tilde p-\tilde M)\tilde p^{m-3}
    \sqrt{\frac2{\delta_{\tilde p}+2}},
  \end{align*}
  where $\sqrt{2\tilde p/\Delta}\ge\sqrt{2/(\delta_{\tilde p}+2)}$ by \eqref{eq:plt23-Delta-upper-sigma}.
  Consequently,
...
Since $\tilde M^2=\delta_{\tilde p}\zeta_p$, the inequality \eqref{eq:plt23-Delta-upper-three} gives
\[
...
\begin{proof}
  ...
  From \eqref{eq:plt23-QL-Delta}, \eqref{eq:plt23-zeta-p-def}, and \eqref{eq:plt23-KA-def}--\eqref{eq:plt23-KA-sum},
  \[
    X
    =\frac{2\tilde p^2(1-\zeta_p)}{\Delta(\delta_{\tilde p}+\zeta_p)^2}
     \left(
...
\begin{proof}
  ...
  From \eqref{eq:plt23-QL-Delta}, \eqref{eq:plt23-KL-def}, \eqref{eq:plt23-KL-sum}, and \eqref{eq:plt23-Delta-upper-sigma},
  \[
    Y\ge
    m(1-\tilde M)(\tilde p-\tilde M)\tilde p^{m-3}
    \sqrt{\frac2{\delta_{\tilde p}+2}}.
