...
\begin{proof}
  ...
  Every admissible $\overline\gamma$ is nonpositive, so $\kappa-b\overline\gamma\ge\kappa$, and the right side of \eqref{eq:plt23-one-d-t} is at least
  \[
    M_m\frac{\kappa^2}{\norm{\phi_\perp}^2}.
  \]
  ...
  \]
  because this inequality is equivalent to $\bigl((\Lambda-q)a_\phi^2-(\Lambda-M)\norm{\phi_\perp}^2\bigr)^2\ge0$.
  ...
  A minimizer in \eqref{eq:plt23-one-d-t} may be taken with $\overline\gamma\ge0$: replacing a negative $\overline\gamma$ by $0$ decreases both terms, so \eqref{eq:plt23-gamma-range}--\eqref{eq:plt23-gamma-beta-v} hold.
  ...
  We now bound the objective of \eqref{eq:plt23-one-d-t} from below at each admissible $\overline\gamma\ge0$.
  Abbreviate
  \[
    w=\frac{(\Lambda-q)\sqrt{2\Lambda}}{2}-b\overline\gamma,
  \]
  so that $\kappa-b\overline\gamma\ge w+(\Lambda-M)\norm{\phi_\perp}^2/2$ by \eqref{eq:plt23-H-lower}.
  Since $x\mapsto\pos x^2$ is nondecreasing and $\norm{\phi_\perp}^2>0$,
  \[
    \frac{M_m}{\norm{\phi_\perp}^2}\pos{\kappa-b\overline\gamma}^2
    \ge M_m\,
    \frac{\pos{w+(\Lambda-M)\norm{\phi_\perp}^2/2}^2}{\norm{\phi_\perp}^2}
    \ge2M_m(\Lambda-M)\pos w,
  \]
  the last step by \eqref{eq:plt23-K-AMGM} with $t=\norm{\phi_\perp}^2$.
  This removes $\norm{\phi_\perp}$ from the objective, and $b$ is removed next: as $\overline\gamma\ge0$ and $b\le\beta(\overline\gamma)$ by \eqref{eq:plt23-beta-gamma}, we have $b\overline\gamma\le\overline\gamma\beta(\overline\gamma)$, so
  \[
    \pos w\ge
    \pos{\frac{(\Lambda-q)\sqrt{2\Lambda}}{2}
    -\overline\gamma\beta(\overline\gamma)}.
  \]
  Finally, \eqref{eq:plt23-gamma-range} bounds the admissible $\overline\gamma$ by $(1-2\Lambda)/(2\sqrt{2\Lambda})$, and enlarging the range of a minimum only decreases it.
  ...
  \]
  For the first term, \eqref{eq:plt23-v-def} gives $\Lambda_m\overline\gamma^2=\Omega_m\rho\overline v^2$, and the definitions \eqref{eq:plt23-C-xi-rho} and \eqref{eq:plt23-rho-def} also give
  \[
    2M_m(\Lambda-M)\frac{\sqrt{2\Lambda}\,(1-2\Lambda)^2}{8\Lambda^2}
    =\Omega_m.
  \]
  Hence the objective of \eqref{eq:plt23-one-d-gamma} is at least $\Omega_m\bigl(\rho\overline v^2+\pos{\xi-\overline v+\overline v^2}\bigr)$ at every admissible $\overline\gamma$, and minimizing over $\overline v\in[0,1]$ gives
  \[
    \Lambda_m\gamma^2+M_m\norm{g_s}^2
