...
\begin{proof}
  ...
  The only eigenfunction quantity left is $u_\gamma$, which bounds the range of the minimum.
  By \eqref{eq:plt23-gamma-range} that range lies in $[0,(1-2\Lambda)/(2\sqrt{2\Lambda})]$, which \eqref{eq:plt23-v-def} carries onto $[0,1]$, so
  \begin{align*}
