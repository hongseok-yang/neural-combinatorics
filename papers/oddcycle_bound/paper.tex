...
\begin{abstract}
  ...
  Our theorem extends the corresponding $C_5$ result of Bennett, Dudek, Lidick\'{y} and Pikhurko~\cite{bennett2020minimizing}, which applies at the discrete densities $p=1-1/k$ with $k\ge3$, in two directions: it treats every odd cycle and gives a single uniform bound throughout $p\ge2/3$.
