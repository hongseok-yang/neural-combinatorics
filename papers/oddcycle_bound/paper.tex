...
Using the trace decomposition from the first step, we write the difference between the two sides of \eqref{eq:intro-commonality} as follows.
\[
  \begin{aligned}
...
The integral representation \eqref{eq:pge23-laplace-gamma} can be written as
\[
