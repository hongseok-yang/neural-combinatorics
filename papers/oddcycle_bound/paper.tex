...
The edge density is not required to equal $p_k$ exactly.
This matters for finite graphs, whose edge densities are rational with denominator $\binom n2$ and therefore almost never equal $1-1/k$.
