...
The Erd\H os--Stone--Simonovits theorem~\cite{erdos1966limit,erdos1946structure} answers it asymptotically: if $\chi(H)=r+1$, then every $H$-free graph has edge density at most $1-1/r+o(1)$.
