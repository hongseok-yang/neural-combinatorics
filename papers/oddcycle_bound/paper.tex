...
The block forms in \eqref{eq:block-UW} give
\[
...
Grouping the contributions by the number and lengths of excursions produces sums of monomials, which we write using complete homogeneous symmetric polynomials.
