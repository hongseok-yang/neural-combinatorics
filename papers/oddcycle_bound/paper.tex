...
In the corresponding block decomposition of the matrix, the entry in the constant direction records the edge density, while the remaining blocks record how the graphon deviates from being constant.
...
After diagonalizing the nonconstant block, the commonality gap becomes a sum of integrals of explicit polynomials $P_{m,r}(q;\lambda_1,\ldots,\lambda_r)$ against a positive spectral measure supported on $[-1/2,1/2]$.
