...
Our proof of \Cref{thm:main} proceeds through a stronger two-colour inequality for $W$ and its complement $1-W$.
The sum of their odd-cycle densities exhibits a cancellation unavailable in $\tC mW$ alone, making the stronger statement more tractable than the original one.
This two-colour formulation is naturally expressed through \emph{commonality}.
...
In the resulting matrix decomposition, the constant vector records the prescribed edge density and its orthogonal complement records the nonconstant part of the graphon.
Passing from $U=1-W$ to $W$ reverses the sign of the block on this orthogonal complement.
Because $m$ is odd, the terms contained entirely in that block cancel when $\tC mW$ and $\tC mU$ are added.
This is why the stronger two-colour inequality is easier to approach than the one-colour bound alone.
