...
Our proof combines the trace expansions for $W$ and $1-W$ so that certain terms cancel, then shows that the remaining terms cover the path-density correction in \eqref{eq:intro-commonality}.
