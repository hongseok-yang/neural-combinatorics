...
Thomason~\cite{thomason1989disproof} disproved both conjectures with $K_4$, and Jagger, \v S\v tov\'i\v cek and Thomason~\cite{jagger1996multiplicities} later proved that no graph containing $K_4$ is common.
...
The present proof does not extend to this range because it first establishes the stronger two-colour inequality in \Cref{thm:commonality}, and that inequality can fail when $1/2<p<2/3$.
