...
Together with the immediate case $p\le1/2$, where the right-hand side is nonpositive, the two papers cover every edge density.
...
The companion paper requires different methods; we explain the reason for the split at $p=2/3$ in \Cref{sec:conclusion}.
