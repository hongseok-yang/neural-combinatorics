...
Let $W\colon[0,1]^2\to[0,1]$ be a graphon with $\edens W=p$, and
write
\[
  U=1-W,
  \qquad
...
The matrix identities and excursion expansions below hold at every edge density; the restriction $p\ge2/3$ enters only in the positivity argument in \Cref{sec:excursion-positivity}.
