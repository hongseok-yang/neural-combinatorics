...
The central role of $W_k$ is already visible in the two previously known cases.
For $m=3$, Goodman's inequality answers this question, with $W_k$ attaining equality at $p=1-1/k$: every graphon $W$ with $\edens W=p$ satisfies
...
Before this work, no corresponding result was known for longer odd cycles.
...
Kim and Lee~\cite{kim2024extended} established the following sharper statement, called \emph{extended commonality}, for every path or cycle $H$ and every graphon $W$ with $\edens W=p$:
