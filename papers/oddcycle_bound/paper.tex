...
We have proven the same lower bound on the range $p \in (1/2, 2/3)$, but the proof is not interpretable and we are in the process of polishing it to make it more readable.
